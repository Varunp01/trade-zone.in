                ...
                <tbody>
                  ...
                  @foreach ($users as $user)
                    <tr>
                        ...
                        <td>{{ $user->amount }}</td>
                        <td>{{ $user->monthly_roi }}</td>
                        <td>{{ $user->first_level }}</td> 

                        <td><a href="{{ route('admin.user.detail',$user->id) }}"><button class="btn btn-primary">View Detail</button></a></td>

                      
                            @if ($user->status == '0')
                            <td><a href="{{ URL('/admin/active-inactive/').'/'.$user->id.'/0' }}" onclick="return confirm('Are you sure to make active')"><button class="btn btn-danger">Inactive</button></a></td>

                          @else
                          <td><a href="{{ URL('/admin/active-inactive/').'/'.$user->id.'/1' }}" onclick="return confirm('Are you sure to make inactive')"><button class="btn btn-success">Active</button></a></td>
