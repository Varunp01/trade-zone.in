    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            @if(\Session::has('success'))
                ...
                <form action="{{ route('admin.add.investor') }}" method="post">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" name="uname"  class="form-control" value="{{ $user->user_name }}" readonly>

                    </div>

                     <div class="form-group">

                        <label for="formGroupExampleInput2">Referal_code</label>

                        <input type="text" name="referal"  class="form-control" value="{{ $user->referal_code }}" readonly>
