        ...
        <!-- <div class="maindtacomb">
            ...
            <table id="example" class="display" cellspacing="0" width="100%">
                ...
                <tbody>
                  ...
                  @php 
                    $user = App\Models\User::where('id',$withdraw->user_id)->first();
                @endphp
                    <tr>
                        <td>{{ $user->name }}</td>
                        <td>{{ $user->phone }}</td>
                        ...
                        @php 
                            @if ($status == '0') 
                                <td><a href="{{ URL('/admin/approve-cancel-withdraw/').'/'.$withdraw->id.'/approve' }}" onclick="return confirm('Are you sure to Approve')"><button class="btn btn-primary">Approve</button></a></td>
                                <td><a href="{{ URL('/admin/approve-cancel-withdraw').'/'.$withdraw->id.'/cancel' }}" onclick="return confirm('Are you sure to Cancel')"><button class="btn btn-danger">Cancel</button></a></td>
