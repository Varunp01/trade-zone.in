    ...
    <div class="container-fluid">
        ...
        <!-- <div class="maindtacomb">
            ...
            <table id="example" class="display" cellspacing="0" width="100%">
                ...
                <thead>
                     <ul class="my-row" style="background-color:#1f6e4d">
                    <li><a href="{{ route('user.team.level',[base64_encode(session()->get('referal_code')),'1']) }}">Level 1</a></li>
                    <li><a href="{{ route('user.team.level',[base64_encode(session()->get('referal_code')),'2']) }}">Level 2</a></li>
                    <li><a href="{{ route('user.team.level',[base64_encode(session()->get('referal_code')),'3']) }}">Level 3</a></li>
                    <li><a href="{{ route('user.team.level',[base64_encode(session()->get('referal_code')),'4']) }}">Level 4</a></li>
                    <li><a href="{{ route('user.team.level',[base64_encode(session()->get('referal_code')),'5']) }}">Level 5</a></li>
                </ul>
                    <tr>
                        <th>Name</th>
                        <th>Phone</th>
