            ...
            @if(\Session::has('success'))
                ...
                <form action="{{ route('user.kyc') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="adhar_no"  class="form-control" placeholder="Aadhar Number">
                    ...
                    <div class="form-group">
                        ...
                        <label for="formGroupExampleInput2">Ifsc Code</label>
                    ...
                    <div class="form-group">
                        ...
                        <label for="formGroupExampleInput2">Upload Passbook Pic</label>
                     ...
                     <div class="form-group">
                        ...
                        <label for="formGroupExampleInput2">Upload Aadhar Front Pic</label>
                     ...
                     <div class="form-group">
                        ...
                        <label for="formGroupExampleInput2">Upload Aadhar Back Pic</label>
                     ...
                     <div class="form-group">
                        ...
                        <label for="formGroupExampleInput2">Upload Pancard Pic</label>

                        <input type="file" name="pan_pic"  class="form-control">
