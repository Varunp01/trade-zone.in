            ...
            @if(\Session::has('success'))
                ...
                <form action="{{ route('withdraw.request') }}" method="post">
                    ...
                    <div class="form-group">
                        <label for="formGroupExampleInput2">Available Amount</label>
                        <input type="text" name="available"  class="form-control" value="{{ $availableAmt }}" readonly>
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput2">Request Amount</label>
                        <input type="text" name="request_amt"  class="form-control" placeholder="Enter withdraw amount">
                    </div>
